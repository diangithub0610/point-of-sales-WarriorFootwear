...
<body id="page-top">
    ...
    <form action="{{route('barang.update', $barang->kode_barang)}}"  method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" id="deskripsi" class="form-control" name="deskripsi" required value="{{$barang->deskripsi}}"></input>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" class="form-control" id="ukuran" name="ukuran" required value="{{$barang->ukuran}}">
        </div>
        <div class="mt-3">
            <label for="gambar" >Gambar:</label>
            <input type="file" id="gambar" name="gambar" accept="image/*" required value="{{$barang->gambar}}">
        </div>
